		...
		<div class="container-fluid">
			...
			<div class="content-block" role="main">
					...
					<article class="span4 data-block nested">
						<div class="data-container span12">
							...
							<section>
								...
								<h3>Username: </h3>
								<div data-click='username'>
								<span class="uneditable-input"><?php echo $user->username;?></span>
								</div>
								<h3>Password: </h3>
								<button class="btn btn-alt btn-primary" style='float:right; margin-top:20px; display:none;' id='password_button' type="submit">Save</button>
								<div class="control-group " id='control_password'>
								<label class="control-label" for="password">5 Characters minimum</label>
								...
								<div class='input-append'>
									<input id='last_name' type='text' value='<?php echo $user->last_name; ?>'>
									<button class='btn save' type='button' data-click='last_name'>Save</button></div>
								</div>
								<h3>Name: </h3>
								<div class="control-group ">
								<div class='input-append'>
									<input id='name' type='text' value='<?php echo $user->name; ?>'>
									<button class='btn save' type='button' data-click='name'>Save</button>
								</div>
								</div>
								<h3>Email: </h3>
								<div class="control-group ">
								<div class='input-append'>
									...
									<button class='btn save' type='button' data-click='email'>Save</button>
								</div>
								</div>
								...
								<div class="control-group ">
								<div class='input-append'>
									<input id='email_pro' type='text' value='<?php echo $user->email_pro; ?>'>
									<button class='btn save' type='button' data-click='email_pro'>Save</button>
								</div>
								</div>
								<h3>Email Password: </h3>
								<div class="control-group ">
								<div class='input-append'>
									<input id='email_password' type='text' value='<?php echo $user->email_password; ?>'>
									<button class='btn save' type='button' data-click='email_password'>Save</button>
								</div>
								</div>
								<h3>SMTP Host: </h3>
								<div class="control-group ">
								<div class='input-append'>
									<input id='smtp_host' type='text' value='<?php echo $user->smtp_host; ?>'>
									<button class='btn save' type='button' data-click='smtp_host'>Save</button>
								</div>
								</div>
								<h3>SMTP Port: </h3>
								<div class="control-group ">
								<div class='input-append'>
									<input id='smtp_port' type='text' value='<?php echo $user->smtp_port; ?>'>
									<button class='btn save' type='button' data-click='smtp_port'>Save</button>
								</div>
								</div>
							</section>
						</div>
				...
				$('.save').live('click',function(){
					...
					//alert(value);
					$.get('php/personal_setting.php',{key:data,value:value},function(result){
						result = $.trim(result);
						//alert(result);
					});
				...
				$('#password').on('input', function() {
					 ...
					 if(data.length >= 5){
					 	...
					 	$('#control_password').addClass('success');
					 	$('#password_button').show();
					 }else{
					 	$('#control_password').removeClass('error');
					 	$('#control_password').addClass('warning');
					 	$('#password_button').hide();
					 }
				});
				$('#password_button').live('click',function(){
					var data = $('#password').attr('value');
					if(data.length >= 5){
						$.get('php/personal_setting.php',{key:'password',value:data},function(result){
							result = $.trim(result);
						});
					}
				});
