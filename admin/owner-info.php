<?php session_start();
	...
	if(isset($_SESSION['user_id']) && isset($_GET['owner'])){
		$owner_id = $_GET['owner'];
										...
										<div class="col-sm-2">
											<div class="panel panel-default">
												...
												<div class="panel-body"> 
													<p>
														<button class="btn btn-default btn-sm" type="button" id='addPropertie'>Add Propertie</button>
													</p>
													<p>
														<button class="btn btn-default btn-sm" type="button" id='getBill'>Get the Bill</button>
													</p>
													<p>
														<button class="btn btn-default btn-sm" type="button" id='sendEmail'>Send Email</button>
													</p>
												</div>
											</div>
										</div>
								...
								<div class="panel panel-default">
									...
									<table id="" class=" dt_fixed_col table table-striped table-condensed">
										...
										foreach ($reponse as $key => $value) {
											...
											$text.="<td>".$price."</td>";
											$text.="<td>".$statut."</td>";
											if(strtotime($today) > strtotime($dateAvailable))
												$text.="<td> Today </td>";
											else
							    ...
							    function validateEmail(email) { 
									...
									$('.save').click(function(e){
										...
										//return false;
												...
												$('#addPropertie').on('click',function(e){
													e.preventDefault();
													var owner = $('input[name=owner]').attr('value');
													$.post('php/admin.property.php?action=create&owner='+owner,function(result){
														result= result.trim();
														//alert(result);
