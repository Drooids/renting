...
include('class.load.php');
    ...
    if(isset($_GET['limit'])){
    $request = $filter->request_limit($_GET['limit']);
    //echo "Limit:";
     //echo $request;
                                                    ...
                                                    $donnees3 = $reponse->fetchAll();
                                                        if(count($donnees3) != 0){
                                                            ...
                                                            if($j == 0){
                                                                  ...
                                                                  echo"<li style='display:none;'> <a href='admin/upload/uploadstimthumb.php?src=".$id_portfolio."/".$nom_fichier."&w=500' rel='prettyPhoto[gallery".$k."]' class='link-viewimages' title='View Images'>View Images</a>";
                                                                  echo"</li>";
                                                            }
                                                        }
                                                }
