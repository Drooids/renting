	   													...
	   													foreach ($reponse as $key => $value) {
	   														$owner = $value['id'];
	   															...
	   															foreach ($reponse2 as $key2 => $value2) {
	   																$text.="<a href='#?id_portfolio=".$value2['id_portfolio']."'>".$value2['id_portfolio']."</a> ";
	   															}
	   														echo "<li><div class='media'>";
	   														echo "<img alt='' src='img/avatars/avatar_18.jpg' class='media-object img-thumbnail pull-left'>";
	   														echo "<div class='media-body'>";
	   														echo "<p class='contact_list_username'><a href='client-info.php?owner=".$value['id']."'>".$value['owner_lastname']." ".$value['owner_name']."</a></p>";
